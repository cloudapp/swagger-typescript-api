...
export interface IMySuperPrefixIssuesDetailParams4MySuperSuffix {
  /**
   * Issues assigned to you / created by you / mentioning you / you're
   * subscribed to updates for / All issues the authenticated user can see
   *
...
export interface IMySuperPrefixIssuesListParams3MySuperSuffix {
  /**
   * Issues assigned to you / created by you / mentioning you / you're
   * subscribed to updates for / All issues the authenticated user can see
   *
...
export interface IMySuperPrefixIssuesListParams5MySuperSuffix {
  /** The sort field. if sort param is provided. Can be either asc or desc. */
  order?: "desc" | "asc";
...
export interface IMySuperPrefixReposDetailParams4MySuperSuffix {
  type?: "all" | "public" | "private" | "forks" | "sources" | "member";
  /** Name of user. */
  username: string;
}
...
export interface IMySuperPrefixRepositoriesListParams8MySuperSuffix {
  /** The sort field. if sort param is provided. Can be either asc or desc. */
  order?: "desc" | "asc";
  /**
...
export interface IMySuperPrefixStarredListParams8MySuperSuffix {
  /** Ignored without 'sort' parameter. */
  direction?: string;
  sort?: "created" | "updated";
}
...
export interface IMySuperPrefixUsersListParams3MySuperSuffix {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  repos = {
     ...
     */
    issuesDetail: (
      { owner, repo, ...query }: IMySuperPrefixIssuesDetailParams4MySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixIssuesMySuperSuffix, void>({
  ...
  search = {
     ...
     */
    issuesList: (query: IMySuperPrefixIssuesListParams5MySuperSuffix, params: RequestParams = {}) =>
     ...
     */
    repositoriesList: (query: IMySuperPrefixRepositoriesListParams8MySuperSuffix, params: RequestParams = {}) =>
  ...
  user = {
     ...
     */
    issuesList: (query: IMySuperPrefixIssuesListParams3MySuperSuffix, params: RequestParams = {}) =>
      this.request<IMySuperPrefixIssuesMySuperSuffix, void>({
        path: `/user/issues`,
        method: "GET",
        query: query,
     ...
     */
    starredList: (query: IMySuperPrefixStarredListParams8MySuperSuffix, params: RequestParams = {}) =>
      this.request<IMySuperPrefixGitignoreMySuperSuffix, void>({
        path: `/user/starred`,
        method: "GET",
        query: query,
  ...
  users = {
     ...
     * @request GET:/users
     */
    usersList: (query: IMySuperPrefixUsersListParams3MySuperSuffix, params: RequestParams = {}) =>
      this.request<IMySuperPrefixUsersMySuperSuffix, void>({
        path: `/users`,
        method: "GET",
        query: query,
     ...
     */
    reposDetail: ({ username, ...query }: IMySuperPrefixReposDetailParams4MySuperSuffix, params: RequestParams = {}) =>
      this.request<IMySuperPrefixReposMySuperSuffix, void>({
